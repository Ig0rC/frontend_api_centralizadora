...
import { HomeIcon, DeviceMobileIcon } from '@heroicons/react/outline';
import { Link } from 'react-router-dom';

const Register = [
  {
    name: 'Empresa Cliente',
    description: 'Cadastrar Empresas para usar App SoftVendedor',
    href: '/cadastrar-empresa-cliente',
    icon: HomeIcon,
  },
  {
    name: 'Empresa Revenda',
    description: 'Cadastrar Empresa para administração do SoftVendedor.',
    href: '/cadastrar-empresa-revenda',
    icon: HomeIcon,
  },
  {
    name: 'Tipo App',
    description: 'Cadastrar nova configuração App.',
    href: '/cadastrar-app',
